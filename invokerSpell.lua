...
invoker.optionEnable = Menu.AddKeyOptionBool({ "ScriptsByMadaspe","c", "One Key Spell"}, "Enabled", "Auto Chain")
invoker.optionColdSnap = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Cold Snap", Enum.ButtonCode.KEY_Y)
invoker.optionGhostWalk = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Ghost Walk", Enum.ButtonCode.KEY_V)
invoker.optionIceWall = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Ice Wall", Enum.ButtonCode.KEY_G)
invoker.optionEMP = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "EMP", Enum.ButtonCode.KEY_C)
invoker.optionTornado = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Tornado", Enum.ButtonCode.KEY_X)
invoker.optionAlacrity = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Alacrity", Enum.ButtonCode.KEY_Z)
invoker.optionSS = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Sun Strike", Enum.ButtonCode.KEY_T)
invoker.optionForgeSpirit = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Forge Spirit", Enum.ButtonCode.KEY_4)
invoker.optionChaos = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Chaos Meteor", Enum.ButtonCode.KEY_5)
invoker.optionBlast = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Deafening Blast", Enum.ButtonCode.KEY_B)
invoker.optionStop = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Stop Combo", Enum.ButtonCode.KEY_7)
invoker.optionOrchid_ColdSnap = Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Orchid Cold Snap Alacrity", Enum.ButtonCode.KEY_N)
invoker.optionTornado_EMP= Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Tornado EMP", Enum.ButtonCode.KEY_K)
invoker.optionEul_Sunstrike_Chaos_Blast= Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Eul Sunstrike Chaos Blast", Enum.ButtonCode.KEY_L)
invoker.optionRefresher= Menu.AddKeyOption({ "ScriptsByMadaspe","Invoker", "One Key Spell"}, "Refresher Combo", Enum.ButtonCode.KEY_J)
invoker.castQueue ={}
invoker.nextTick = 0
